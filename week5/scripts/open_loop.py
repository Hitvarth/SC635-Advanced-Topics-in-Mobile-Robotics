...
if __name__ == '__main__':
    main()
    global odom_x, odom_y
    plt.plot(odom_y, odom_x)
    plt.show()
    print('Distance from (1,0) and current position is ' + str((math.sqrt((1 - odom_x[-1])**2 + odom_y[-1]**2))))
    print('Difference between (1,0) and current position is (' + str(1 - odom_x[-1]) + ',' + str(-odom_y[-1]) + ')')
